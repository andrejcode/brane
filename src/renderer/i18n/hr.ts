...
export const hr: Messages = {
  ...
  'sidebar.search': 'Pretraži razgovore',
  'sidebar.noMatch': 'Nijedan razgovor ne odgovara upitu „{query}“.',
  ...
  'general.loadModelOnStartup': 'Učitaj odabrani model pri pokretanju',
  'general.loadModelOnStartupDescription':
    'Automatski učitaj odabrani model kada se Brane pokrene.',
  ...
  'shortcuts.toggleModels': 'Prikaži/sakrij popis modela',
